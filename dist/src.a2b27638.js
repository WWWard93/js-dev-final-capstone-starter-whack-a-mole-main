...
var points = 0;
var difficulty = '';
var song = new Audio("../assets/mtfc.mp3");
...
document.getElementById("easy").addEventListener("click", function () {
  return difSelect("easy");
});
document.getElementById("normal").addEventListener("click", function () {
  return difSelect("normal");
});
document.getElementById("hard").addEventListener("click", function () {
  return difSelect("hard");
});
...
function hitSound() {
  var audio = new Audio("../assets/grunt.mp3");
  audio.play();
}
...
function menuHide() {
  var moleSpeedContainer = document.getElementById('moleSpeed');
  var clickStart = document.getElementById('startTitle');
